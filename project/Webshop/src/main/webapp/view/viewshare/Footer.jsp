...
<footer id="footer" class="footer">
    <div>
        ...
        <p class="text">Hotline: 093 407 6342</p>
        <div class="gov-badge">
            <img src="https://placehold.co/100x50" alt="Government certification badge">
        </div>
    </div>
    <div>
        <h3>Liên kết</h3>
    ...
    <div>
        ...
        <p class="text"><i class="fas fa-phone"></i> 093 407 6342</p>
        <p class="text"><i class="fas fa-fax"></i></p>
        <p class="text"><i class="fas fa-envelope"></i> 22130099@gmail.com</p>
    </div>
    <div>
    </div>
</footer>
