        ...
        <div class="card-body">
            ...
            <form action="${pageContext.request.contextPath}/UpdateProductAdmin" method="post">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th scope="row">Ngày nhập hàng</th>
                        <td>
                ...
                <div class="mt-3 text-end">
                    <a href="<c:url value="/LoadProductAdmin"/>" class="btn btn-dark px-4">Quay lại</a>
                    <button type="submit" class="btn btn-dark px-4">Cập nhật thông tin sản phẩm</button>
                </div>
            </form>
